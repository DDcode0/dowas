...
function animateAndNavigate(optionId) {
    ...
    switch (optionId) {
        case 'normal':
            url = 'normal/indexNormal.html'; // URL para Binomial
            break;
        case 'exponencial':
            url = 'exponencial/indexExponencial.html'; // URL para Multinomial
            break;
        case 'uniforme':
            url = 'distribucionUniforme/indexUniforme.html'; // URL para Poisson
            break;
        default:
